              ...
              <div className="rounded-[2rem] border border-slate-200 bg-slate-50 p-6 shadow-sm">
                ...
                <div className="mt-6 space-y-4 text-slate-700">
                  <div>
                    ...
                    <div className="font-semibold">Hon. Abdulkareem Sabo Abdullahi (ASAJ)</div>
                  </div>
                  <div>
                    <div className="text-sm text-slate-500">Office Sought</div>
                    <div className="font-semibold">House of Representatives</div>
                  </div>
                  <div>
                    <div className="text-sm text-slate-500">Constituency</div>
                    <div className="font-semibold">Yola North | Yola South | Girei Federal Constituency</div>
                  </div>
                  <div>
                    <div className="text-sm text-slate-500">Party</div>
                    <div className="font-semibold">All Progressives Congress (APC)</div>
                  </div>
                  <div>
                    <div className="text-sm text-slate-500">Current Role</div>
                    <div className="font-semibold">Senior Legislative Aide to the Deputy Speaker</div>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="rounded-[2rem] border border-white/10 bg-white/5 p-6 shadow-sm">
              <div className="space-y-5 text-sm">
                <div>
                  ...
                  <div className="mt-1 text-base">National Assembly Complex, Three Arm Zone, Abuja, Nigeria</div>
                </div>
                <div>
                  <div className="text-slate-400">Email</div>
                  <div className="mt-1 text-base">asajjimeta05@gmail.com</div>
                </div>
                <div>
                  <div className="text-slate-400">Phone</div>
                  <div className="mt-1 text-base">07039861004</div>
                </div>
                <div>
